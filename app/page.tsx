    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
            ...
            <Link href="https://github.com/saurabhhh777/swapxcontract" target="_blank">
              <Button variant="outline" className="text-lg px-8 py-6 border-gray-700 text-white bg-gray-800 hover:bg-gray-700">
          ...
          <div className="relative">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-1 inline-block">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 hover:border-blue-500 transition-all duration-300">
            <CardHeader>
          ...
          <Card className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 hover:border-purple-500 transition-all duration-300">
            <CardHeader>
          ...
          <Card className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 hover:border-green-500 transition-all duration-300">
            <CardHeader>
      ...
      {/* Stats Section */}
      <section className="container mx-auto px-4 py-16 bg-gradient-to-r from-gray-800/30 to-gray-900/30 border-y border-gray-800">
      ...
      {/* Footer */}
      <footer className="bg-gray-900/80 backdrop-blur-sm border-t border-gray-800 pt-16 pb-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/saurabhhh777/SwapX" className="text-gray-400 hover:text-white transition-colors">
                  <Github />
                </a>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/swap" className="text-gray-400 hover:text-white transition-colors">Swap</a></li>
                <li><a href="/liquidity" className="text-gray-400 hover:text-white transition-colors">Liquidity</a></li>
                <li><a href="/dashboard" className="text-gray-400 hover:text-white transition-colors">Analytics</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="https://x.com/askbunnyyy" className="text-gray-400 hover:text-white transition-colors">Twitter</a></li>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="/legal/terms" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">Terms</a>
              <a href="/legal/privacy" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">Privacy</a>
              <a href="/legal/cookies" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">Cookies</a>
              <a href="/legal/disclaimer" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">Disclaimer</a>
            </div>
          </div>
        </div>
      </footer>
